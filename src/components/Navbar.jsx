...
const Navbar = ({ search, setSearch, cartCount }) => {
  ...
  return (
    <header className="bg-white shadow-lg p-6 flex flex-col md:flex-row justify-between items-center fixed w-full top-0 z-50">
